...
# Import base tool with fallback
try:
    from src.agent.tools.base_tool import AgentTool, ToolResult, ToolParameters
except ImportError:
    try:
        from agent.tools.base_tool import AgentTool, ToolResult, ToolParameters
    except ImportError:
        # Minimal interface for standalone operation
        class AgentTool:
